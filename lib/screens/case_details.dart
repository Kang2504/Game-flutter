            ...
            body: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildLabel("MANH MỐI VÀ CHỨNG CỨ"),
                  Padding(
                  ...
                  _buildLabel("LỜI KHAI"),
                  Padding(padding: const EdgeInsets.only(left: 16.0, right: 16.0, bottom: 10.0),
                    child: Text(
                      "Hãy nhớ, hung thủ luôn nói dối. Những người khác thì nói thật",
                      style: const TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.bold,
                        color: Colors.brown,
